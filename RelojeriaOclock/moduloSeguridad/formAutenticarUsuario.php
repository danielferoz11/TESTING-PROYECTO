...
class formAutenticarUsuario
{
	...
	{
		headSingleton::getHead('Iniciar sesión');
		...
		<html lang="es">
			...
			<head>
				...
				<link rel="shorcut icon" type="image/x-icon" href="img/logooo.png">
			...
			<body>
				<div  class="form-contenedor" >
					...
					<form name="form1" id="form1" name="form1"  method="post" action="../relojeriaconpatrones3/moduloSeguridad/getEntrar.php">
							...
							<tr>
								...
								<td >
									<label>
										...
										class="input" name="nombre" type="text" id="nombre" />
									</label>
								</td>
							</tr>
							<tr>
		...
		footSingleton::getFoot('Autenticando Usuario...');
